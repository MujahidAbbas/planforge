<div class="h-full flex flex-col p-6">
    ...
    @if(!$this->document)
        ...
        <div
            ...
            x-data="{
                selectedTemplateName: '{{ $this->project->prdTemplate?->name ?? 'No template selected' }}',
                sectionCount: {{ $this->project->prdTemplate ? count($this->project->prdTemplate->sections ?? []) : 0 }},
                hasTemplate: {{ $this->project->prd_template_id ? 'true' : 'false' }}
            }"
            ...
            <div class="flex-1 overflow-y-auto">
                <div class="max-w-3xl w-full mx-auto p-8">
                    <div class="text-center mb-8">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">Create Your PRD</h3>
            ...
            <div class="sticky bottom-0 border-t border-gray-200 bg-gradient-to-r from-gray-50 via-white to-gray-50 px-6 py-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                <div class="max-w-3xl mx-auto flex items-center justify-between gap-4">
                    ...
                    >
                        ...
                        <span wire:loading.remove wire:target="$dispatch('startPlanRun')">Generate PRD with AI</span>
